...
public class ListViewSwipeGesture implements OnTouchListener {
    ...
    private TextView mDownView_parent_txt1,mDownView_parent_txt2,mDownView_parent_txt3;
    ...
    {                                           //Callback functions
        ...
        void FullSwipeListView2(int position);
    ...
    private void GetResourcesValues() {
        ...
        HalfColor           =   activity.getResources().getString(R.string.str_black);
        //FullColor           =   activity.getResources().getString(R.string.str_orange);         //Orange
        FullColor           =   activity.getResources().getString(R.string.str_black);
...
//        FullDrawable1        =   activity.getResources().getDrawable(R.drawable.rating_favorite);
        HalfDrawable        =   activity.getResources().getDrawable( R.drawable.rating_good );
        FullDrawable        =   activity.getResources().getDrawable(R.drawable.rating_favorite);
        FullDrawable1        =   activity.getResources().getDrawable(R.drawable.rating_favorite);
    }
    ...
    public boolean onTouch(final View view, MotionEvent event)
    {
        if (mViewWidth < 2)
        {
            ...
            largewidth	=	textwidth+textwidth2+textwidth2;
        }
    ...
    private void SetBackGroundforList()
    {
         ...
         mDownView_parent_txt1.setText("PLAY");
         ...
         if(SwipeType==Double)
         {
             ...
             mDownView_parent_txt2.setText("TAGS");
             ...
             //experimentallllllllllllllllllll
             mDownView_parent_txt3 = new TextView(activity.getApplicationContext());
             mDownView_parent_txt3.setId(333333);
             RelativeLayout.LayoutParams lp3 =new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
             ...
             mDownView_parent_txt3.setText("INDEX");
             mDownView_parent_txt3.setWidth(textwidth);
             mDownView_parent_txt3.setPadding(0, textheight/4, 0, 0);
             mDownView_parent_txt3.setHeight(textheight);
             mDownView_parent_txt3.setBackgroundColor(Color.parseColor(FullColor));
             mDownView_parent_txt3.setTextColor(Color.parseColor(TextColor));
             mDownView_parent_txt3.setCompoundDrawablesWithIntrinsicBounds(null , FullDrawable1, null, null );
             mDownView_parent.addView(mDownView_parent_txt3, 2);
            // experimentallllllllllllllllllll
         }
	}
                ...
                .setListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(
                        ...
                        if(SwipeType==Double)
                        {
                            ...
                            mDownView_parent_txt3.setOnTouchListener(new touchClass());
                        }
                        ...
                        if(opened_position==stagged_position && moptionsDisplay){
                            switch (v.getId()) {
                                ...
                                case 222222:
                                    ...
                                    return true;
                                case 333333:
                                    tcallbacks.FullSwipeListView2(temp_position);
                                    return true;
                            }
                        }
                }
